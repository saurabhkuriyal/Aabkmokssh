...
const menuItems = [
  { id: 1, link: "/", title: 'Home', icon: <IoHomeOutline />, gradientFrom: '#a955ff', gradientTo: '#ea51ff' },
  { id: 2, link: "/about", title: 'About Us', icon: <IoPeopleOutline />, gradientFrom: '#56CCF2', gradientTo: '#2F80ED' },
  { id: 3, link: "/explore", title: 'Explore', icon: <IoCompassOutline />, gradientFrom: '#56CCF2', gradientTo: '#2F80ED' },
  ...
  { id: 4, link: "/contact", title: 'Contact', icon: <IoShareSocialOutline />, gradientFrom: '#80FF72', gradientTo: '#7EE8FA' },
